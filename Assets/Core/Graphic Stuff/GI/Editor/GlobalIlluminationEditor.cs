...
namespace GI.Universal {
    ...
    public class GlobalIlluminationEditor : VolumeComponentEditor {
        ...
        SerializedDataParameter brightnessThreshold, brightnessMax, specularContribution, nearCameraAttenuation, saturation, limitToVolumeBounds, aoInfluence;
        ...
        public override void OnInspectorGUI() {
            ...
            if (organicLight.value.floatValue > 0f) {
                EditorGUI.indentLevel++;
                if (!GIRenderFeature.isRenderingInDeferred) {
