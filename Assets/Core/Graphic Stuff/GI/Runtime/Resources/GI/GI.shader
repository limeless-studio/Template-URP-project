...
Subshader {	
  ...
  Pass { // 2
      ...
      #include "GI_BilateralFilter.hlsl"
      ENDHLSL
  }
  ...
  Pass { // 13
      ...
      #pragma multi_compile_fragment _ _GBUFFER_NORMALS_OCT
      #define RGI_BLUR_HORIZ
      #include "GI_WideKernelFilter.hlsl"
      ENDHLSL
  }
