...
namespace GI.Universal {
    ...
    [ExecuteInEditMode, VolumeComponentMenu("Snowy/Global Illumination")]
    public class GlobalIllumination : VolumeComponent, IPostProcessComponent {
        ...
        void Reset() {
            GIRenderFeature.needRTRefresh = true;
        }
