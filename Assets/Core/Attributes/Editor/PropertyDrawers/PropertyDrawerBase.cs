...
namespace Core.Attributes.Editor
{
    public abstract class PropertyDrawerBase : PropertyDrawer
    {
        ...
        {
            float indentLength = SnAttrEditorGUI.GetIndentLength(rect);
            ...
            SnAttrEditorGUI.HelpBox(helpBoxRect, message, MessageType.Warning, context: property.serializedObject.targetObject);
