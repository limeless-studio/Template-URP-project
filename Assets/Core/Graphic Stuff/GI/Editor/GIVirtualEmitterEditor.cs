...
namespace GI.Universal {
    ...
    [CustomEditor(typeof(GIVirtualEmitter))]
    public class GIVirtualEmitterEditor : Editor {
        ...
        protected virtual void OnSceneGUI() {
            GIVirtualEmitter vi = (GIVirtualEmitter)target;
    ...
    public static class RadiantVirtualEmitterEditorExtension {
        ...
        [MenuItem("GameObject/Create Other/GI/Virtual Emitter")]
        static void CreateEmitter(MenuCommand menuCommand) {
            GameObject emitter = new GameObject("Radiant Virtual Emitter", typeof(GIVirtualEmitter));
